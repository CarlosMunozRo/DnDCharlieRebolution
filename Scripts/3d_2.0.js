...
/*import THREE, { OrbitControls } from "https://cdn.skypack.dev/three@0.135.0";*/
...
function init() {
	...
	// RENDERER
	renderer = new THREE.WebGLRenderer({ canvas: document.getElementById('3d-bgk'),antialias: true });
